...
<div class="col-md-8">
	...
	<div class="form-group">
      ...
      <div class="col-md-10">
		 ...
		 <p class="text-center"><small>*Judul Tidak Boleh Mengandung Simbol </small></p>
	  </div>
	</div>
	<div class="form-group">
	<label class="col-md-2 control-label">Isi thread</label>
	<div class="col-md-10">
	      <textarea class="form-control" rows="10" placeholder="Isi thread" name="isi">{{$artikel->isi}}</textarea>
	  </div>	  
	</div>
	<div class="form-group">
		...
		<div class="col-md-10">
		  ...
		  @if(isset($kategoris))
			 ...
			 @if($artikel->id_kategori==$kategori->id)
	...
	<div class="col-xs-12" id="prosesFile"><span class="fa fa-spinner fa-spin"></span></div>
	 <div class="col-md-12">
		<center><img data-src="holder.js/150x150/#4466FF:#fff/text:150px x 150px" src="{{URL::to("/").$artikel->photo}}" id="upload" style="width:150px; height:150px; margin-bottom:5px;" class="thumbnail"> </center>
		<input type="hidden" class="form-control" id="filePhoto" name="filePhoto" value="{{$artikel->photo}}"> 
