<div class="col-md-12 padding-margin-o" style="margin-top:-40px;z-index:9">
<img src="{{URL::to("/")}}/img/bg-bottom-top.png" style="width:100%; height:auto;">
</div>
...
<img src="{{URL::to("/")}}/img/image10.jpg" class="img-bottom-cao">
	...
	<div class="col-md-12 bottom-menu-attack">
		<ul class=" list-unstyled list-inline footer-menu padding-margin-o">
			...
			<li class=""><a href=" <?php echo URL::to("#") ?>">LAUNDRY GUIDE</a></li>
			<?php }else{?>
			<li><a href=" <?php echo URL::to("#") ?>">LAUNDRY GUIDE</a></li>
			<?php }?>	
