...
<br>
<div class="col-md-12"><h2 class="text-left tips-title">Love Batik</h2></div>
@if(!$tips->isEmpty())
	@if(Input::get('page')==null || ((Input::get('page')>=2)==false))
<div class="col-md-12 large-tips" style="border-bottom:1px solid; border-color:rgba(188, 190, 192,0.5); margin-bottom:10px;">
