...
<div class="content-fluid" style="padding-top:20px;">
	<div class="col-md-12 top-cover-smarttips"  >
				<img src="{{URL::to('/');}}/img/smarttips/tips.jpg" class="fullimage">
	</div>
@if(isset($tips))
	@include("frontend.smarttips.leftmenu",array("kategori"=>$tips->idkategori))
@else
...
<?php 
$relatedtips=TipsController::getTipsRelated($tips->idkategori)
?>
<div class="col-xs-12 col-md-12">
<h3 class="text-left text-capitalize related-title" style="">Related Tips</h3>
</div>
