...
<div class="col-md-12">
		<img src="{{URL::to('/');}}/img/smarttips/tips.jpg" style="width:100%">
	</div>
@if(isset($kategori))
	@include("frontend.smarttips.leftmenu",array("kategori"=>$kategori))
@else
...
<br>
<div class="col-sm-12"><h2 class="text-left tips-title">Smart Tips</h2></div>
@if(!($tips->isEmpty()))
	@if(Input::get('page')==null || ((Input::get('page')>=2)==false))
<div class="col-sm-12 large-tips">
<a href="{{URL::to('/tips')}}/{{UsersController::getDate($tips[0]->created_at)}}/{{$tips[0]->id}}/{{ArtikelController::getURL($tips[0]->judul)}}">

<div class="media">
		<div class="media-top">
			   <img src="{{URL::to('/')}}/timthumb.php?src={{URL::to('/admin/'.$tips[0]->photo)}}&h=250&w=400" > 
			   <div class="hover-kategori"><img src="{{URL::to('img/smarttips').'/'.$tips[0]->large_image}}"></div>
		</div>
...
@if($ntips!=0)
<div class=" col-md-6 list-large-tips">
...
<div class="media">
		<div class="media-top">
			   ...
			   <div class="hover-kategori"><img src="{{URL::to('img/smarttips').'/'.$datatips->small_image}}"></div>
		</div>
		<div class="media-body">
