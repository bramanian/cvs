...
<div class="col-xs-12 col-md-12 top-cover-smarttips">
		<center><img src="{{URL::to('/');}}/img/laundryguide/laundry.jpg" class="img-responsive" width="100%"></center>
	</div>
	@if(isset($tips))
	@include("frontend.laundryguide.leftmenu",array("kategori"=>$tips->id_kategori))
    @else
...
<!------------------------------------------------------------------>
<div class="col-xs-12 col-md-9" style="padding-top:30px;">
...
<?php 
$relatedtips=GuideController::getTipsRelated($tips->idkategori)
?>
<div class="col-xs-12 col-md-12">
<h3 class="text-left text-capitalize related-title" style="">Related Laundry Guide</h3>
</div>
