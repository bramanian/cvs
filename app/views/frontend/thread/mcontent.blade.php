...
<div class="col-md-12 top-cover-smarttips">
...
<br>
<div class="col-xs-12 col-md-12"><h2 class="text-left tips-title">Smart Tips</h2></div>
@if(!($tips->isEmpty()))
	@if(Input::get('page')==null || ((Input::get('page')>=2)==false))
<div class="col-xs-12 col-md-12 large-tips">
