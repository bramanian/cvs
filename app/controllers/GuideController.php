...
class GuideController extends \BaseController {
			...
			if(Agent::isMobile())
	{
	 ...
	 return View::make('layout.main',array("content"=>$content,"breadcrumbs"=>array("Home"=>"/","Laundry Guide"=>"/guide","Tips & Trik"=>"")));		
	...
	$datakategori="";				
    switch($kategori){
		case "washingexperience":$datakategori= "Washing Experience"; break;
		case "amazingresult":$datakategori= "mazing Result"; break;
		case "allaboutfabric":$datakategori= "Allabout Fabric"; break;
		case "tipstrik":$datakategori= "Tips & Trik"; break;
