...
@if(isset($tips))
<div class="btn-group"> 
<a href="{{URL::to("/panel/tips")}}/{{$tips->id}}/delete" class="btn btn-danger"> <i class="fa  fa-trash-o"></i> Delete</a>
</div>
<br>
<br>
...
<form action="{{URL::to('/')}}/panel/tips/{{$tips->id}}/update"}}"  method="POST">
	...
	<tr class="alert-warning">
		...
		<div class="col-md-3">Tags </div>
			...
			<div class="col-md-6">
			 ...
			 <div class="col-md-3">
				<button type="button" class="btn btn-primary" onClick="selectTag()" >Add</button>
			  </div>
			  </div>
