<br>
<h1 class="text-left"> Menambahkan Vidio</h1>
<ol class="breadcrumb">
  <li><a href="{{URL::to('admin/vidio')}}"> Vidio</a></li>
  <li>Menambahkan Vidio</li>
</ol>
<br>
<form action="{{URL::to("admin/vidio")}}"  method="POST">
...
<tr class="alert-success">
<td>Link Vidio</td>
<td><input type="text"  name="vidio" value="" placeholder="URL" >   <label class="alert-warning">copy link vidio dari youtube</label></td>
</tr>
 <tr>
 <td>&nbsp;</td>
