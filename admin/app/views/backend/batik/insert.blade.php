...
<h1 class="text-left"> Menambahkan Batik</h1>
<ol class="breadcrumb">
  <li><a href="{{URL::to('/panel/batik')}}"> Batik</a></li>
  <li>Menambahkan Batik</li>
</ol>
<br>
<form action="{{URL::action('TipsController@storeBatik')}}"  method="POST">
