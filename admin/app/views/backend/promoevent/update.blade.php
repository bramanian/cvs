...
<br>
<h1 class="text-left"> Memperbarui Promo & Event </h1>
<ol class="breadcrumb">
  <li><a href="{{URL::to('/panel/promoevent')}}"> &nbsp;Promo & Event </a></li>
  <li>Memperbarui Laundry Guide</li>
</ol>
<br>
@if(isset($tips))
<div class="btn-group"> 
<a href="{{URL::to("/panel/promoevent")}}/{{$tips->id}}/delete" class="btn btn-danger"> <i class="fa  fa-trash-o"></i> Delete</a>
</div>
<br>
<br>
...
<form action="{{URL::to('/')}}/panel/promoevent/{{$tips->id}}/update"}}"  method="POST">
