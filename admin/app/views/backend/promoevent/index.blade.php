<div id="page-wrapper" >
          <h1 class="menu-title btn-block ">Promo & Event</h1>
          <br>
               ...
               @foreach($data as $value)
                @if($n%2==0)					 
                     <tr class="danger" >
						...
						<a class=" btn btn-warning" href="{{URL::to("panel/promoevent/".$value->id)}}/edit"><i class="fa fa-edit"></i></a>
						<a class=" btn btn-danger" href="{{URL::to("/panel/promoevent/".$value->id)}}/delete"><i class="fa fa-trash-o"></i></a>
						</td>
                     </tr>                          
                    @else
                     <tr class="success" >
